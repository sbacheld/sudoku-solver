...
class TestBoard(unittest.TestCase):
    ...
    def test_boxes_units_yields_all_boxes(self):
        # Arrange
        board = Board()
        box_units_sets = []
        expected_box_units_sets = [
        ...
        for box_units in board.boxes_units():
            box_units_sets.append([unit.name for unit in box_units])

        # Assert
        self.assertEqual(len(expected_box_units_sets), len(box_units_sets))
        for i, expected_box_units_set in enumerate(expected_box_units_sets):
            self.assertEqual(expected_box_units_set, box_units_sets[i])
